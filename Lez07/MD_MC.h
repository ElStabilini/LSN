...
double vtail, ptail, bin_size, sd; //serve per g(r)
...
double bins[nbins], stima_g[nbins], err_g[nbins], r[nbins], DeltaV[nbins], g_norm[nbins];

// thermodynamical state
int npart;
double beta,temp,energy,vol,rho,box,rcut,press; //press aggiunta mar 3 mag 2022, 12:05:23 
...
void Preprint(int i);
void PrintUP(int i); //aggiunto mer 20 lug 2022, 18:21:58 
